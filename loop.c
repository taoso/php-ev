...
/* {{{ proto EvLoop EvLoop::defaultLoop([int flags = EVLAG_AUTO[, mixed data = NULL[, double io_collect_interval = 0.[, double timeout_collect_interval = 0.]]]])
*/
...
/* {{{ proto EvLoop EvLoop::__construct([int flags = EVLAG_AUTO[[, mixed data = NULL[, double io_collect_interval = 0.[, double timeout_collect_interval = 0.]]]]) */
